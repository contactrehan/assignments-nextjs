  ...
  return (
    <main>
      <div>
        ...
        <img src="https://www.panaverse.co/red-p-logo-text_dao_croped.png"></img>
        <h2>
        ...
        <iframe
          width="320"
          height="560"
          src="https://www.youtube.com/embed/JjFksIYv6wk"
          title="Which laptop or PC is recommended for React Native development?"
        ...
        <h2 style={{ color: "seagreen" }}>Relevant Information Links</h2>
        <h3>
          <a href="https://www.piaic.org/">Admission Website</a>
        </h3>
        <h3>
          <a href="https://www.facebook.com/groups/panaverse">Facebook Group</a>
        </h3>
        <h3>
          <a href="https://www.youtube.com/@panaverse/streams">
        ...
        <p>
          Fundamentals of JavaScript and Node.js Quiz Topics Covered in the
          Quiz: Background of JavaScript and How to use JavaScript in Browser
        ...
        <ol>
          <li>
            to Node.js, .mjs files, Modules, NPM, import, export, and using
        ...
        <h3 id="object-oriented-programming-with-typescript">
        ...
        <h3 id="fundamentals-of-version-control-with-git-recorded-videos">
        ...
        <h3 id="w2-201-developing-planet-scale-web-20-serverless-cloud-apps-and-apis-using-nextjs-13-and-cloud-development-kit-cdk-for-terraform">
        ...
        <h3 id="nextjs-13-using-chakra-ui-remote-zoom-class">
          Next.js 13 using Chakra UI (Remote Zoom Class)
        </h3>

        <p>Chakra UI Docs https://chakra-ui.com/getting-started</p>

        <p>
          CSS Flexbox Explained – Complete Guide to Flexible Containers and Flex
          Items https://www.freecodecamp.org/news/css-flexbox-complete-guide/
        </p>

        <h3 id="uiux-design-with-figma-tailwindcss-and-chakra-ui-remote--zoom-class">
        ...
        <p>
          <a href="https://www.figma.com/community/file/768809027799962739">
            Figma Design Kit for TailwindCSS
          </a>
        </p>

        <p>
          <a href="https://www.figma.com/community/file/971408767069651759">
            Chakra UI Figma Kit
          </a>
        </p>
        ...
        <h3 id="nextjs-13-using-tailwindcss-remote-zoom-class">
        ...
        <h3 id="aws-application-composer-remote-zoom-class">
        ...
        <p>
          ...
          (https://www.nayapay.com/ ) which can be used to create AWS/GCP/Azure
          accounts. This is good news for those students who find it difficult
          to create physical debit and credit cards from banks.
        </p>
        ...
        <h3 id="multi-cloud-graphql-serverless-api-development-with-cloud-development-kit-for-terraform-cdktf-remote-zoom-class">
        ...
        <h3 id="earn-while-you-learn-projects">
          Earn While You Learn Projects
        </h3>

        <h3 id="build-full-stack-nextjs-13-jamstack-templates">
        ...
        <h2 id="web-3-and-metaverse-specialization">
          Web 3 and Metaverse Specialization
        </h2>

        <h3 id="quarter-iii-web3-and-metaverse">
          Quarter III Web3 and Metaverse
        </h3>

        <h3 id="w3-351-developing-smart-contracts-and-planet-scale-web-30-dapps">
        ...
        <h3 id="blockchain-and-metaverse-theory">
        ...
        <h3 id="smart-contract-development-in-solidity">
        ...
        <h3 id="dapp-development-using-ethersjs-and-nextjs-13">
        ...
        <p>
          By creating a token and related contracts, you’ll also learn how to
        ...
        <p>
          Therefore, for the sake of this chapter, let’s imagine that our Pako
        ...
        <p>
          ...
          the contract’s balance should have been reduced.
        </p>
        ...
        <p>
          ...
          in the token contract’s address in the address field.
        </p>
        ...
        <h2 id="quarter-iv-web3-and-metaverse">
          Quarter IV Web3 and Metaverse
        </h2>

        <h2 id="mv-361-developing-planet-scale-open-virtual-and-augmented-metaverse-experiences">
        ...
        <p>
          <a href="https://www.blender.org/download/">Blender 3+ Download</a>
        </p>
        ...
        <p>
          ...
          tutorials https://www.youtube.com/watch?v=bpvh-9H8S1g
        </p>
        <br /><br /><br /><br />
